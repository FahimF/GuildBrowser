...
//    NSString *nameLevelClass = [NSString stringWithFormat:@"%@ - %@ - %@",
//                                _character.name,
...
//                                _character.level];
    ...
    [[WoWApiClient sharedClient] characterWithName:_character.name onRealm:_character.realm success:^(Character *characterWithDetails) {
       ...
       _selectedSpec.text = [NSString stringWithFormat: @"%@ %@",characterWithDetails.selectedSpec,characterWithDetails.classType];
       ...
       if (characterWithDetails.title) {
        ...
        //TODO: charlie get "class" image and set as background for surrounding, not sure blizzard will like this though                                               
        //TODO: charlie start work on getting the item detail info in a background thread
