...
{
    return [self initWithName:[itemData valueForKey:@"name"]
                       itemId:[itemData valueForKey:@"id"]
                         icon:[itemData valueForKey:@"icon"]
                      quality:[[itemData valueForKey:@"quality"] integerValue]];
}
